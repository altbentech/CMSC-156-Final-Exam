...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        val dogInfo = dogsList[position]
        holder.dogPicture?.setImageResource(dogInfo.imageResourceId)
        ...
        holder.dogHobby?.text = resources?.getString(R.string.dog_hobbies, dogInfo.hobbies)
    }
}
